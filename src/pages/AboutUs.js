...
const AboutUs = () =>{
    return(
        ...
        <InfoContainer title="Información Adicional" content="Las dependencias usadas son: react, react-router-dom, Firebase, Material UI y Swiper." image="kitten-pc.jpg" />
        </>
    )
}
